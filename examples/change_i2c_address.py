...
parser.add_argument('--desired', type=lambda x: int(x, 0), help='The desired VL53L8CX i2c address.', required=True)
...
sensor = vl53l8cx.VL53L8CX(addr_current, skip_init=True)
